...
import AnnouncementInformationV9 from '@/components/thema-v9/information/announcement'
import AnnouncementInformationV10 from '@/components/thema-v10/information/announcement'
import AnnouncementInformationV11 from '@/components/thema-v11/information/announcement'
import AnnouncementInformationV13 from '@/components/thema-v13/information/announcement'
import AnnouncementInformationV14 from '@/components/thema-v14/information/announcement'
import AnnouncementInformationV15 from '@/components/thema-v15/information/announcement'
import AnnouncementInformationV16 from '@/components/thema-v16/information/announcement'
...
const InfoAnnouncementsPage = async () => {
  ...
  switch (theme) {
    ...
    case 'THEMA_PRODI_SEMBILAN': {
      return <AnnouncementInformationV9 />
    }
    case 'THEMA_PRODI_SEPULUH': {
      return <AnnouncementInformationV10 />
    }
    case 'THEMA_PRODI_SEBELAS': {
      return <AnnouncementInformationV11 />
    }
    case 'THEMA_PRODI_DUA_BELAS': {
      return <AnnouncementInformationV11 />
    }
    case 'THEMA_PRODI_TIGA_BELAS': {
      return <AnnouncementInformationV13 />
    }
    case 'THEMA_PRODI_EMPAT_BELAS': {
      return <AnnouncementInformationV14 />
    }
    case 'THEMA_PRODI_LIMA_BELAS': {
      return <AnnouncementInformationV15 />
    }
    case 'THEMA_PRODI_ENAM_BELAS': {
      return <AnnouncementInformationV16 />
    }
  }
}
