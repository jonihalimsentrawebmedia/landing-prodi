...
import NewsInformationPageV15 from '@/components/thema-v15/information/news'
import NewsInformationPageV16 from '@/components/thema-v16/information/news'
...
const NewsPage = async () => {
  ...
  switch (theme) {
    ...
    case 'THEMA_PRODI_LIMA_BELAS': {
      return <NewsInformationPageV15 />
    }
    case 'THEMA_PRODI_ENAM_BELAS': {
      return <NewsInformationPageV16 />
    }
  }
}
