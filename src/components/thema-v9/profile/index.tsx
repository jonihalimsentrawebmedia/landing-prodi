      ...
      <div className="bg-primary/10 py-5">
        <div className="container-sm pb-5">
          ...
          >
            ...
            >
              <div className="absolute z-10 w-[2px] h-full left-0 bg-linear-to-b from-primary to-primary/10 hidden lg:block" />
              <div className="absolute z-10 w-[2px] h-full right-0 bg-linear-to-b from-primary to-primary/10 hidden lg:block" />
              {TabsData?.map((row, k) => (
                <TabsTrigger
                  value={row?.link}
                  key={k}
