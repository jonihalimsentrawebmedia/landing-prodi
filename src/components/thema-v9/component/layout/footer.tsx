...
const FooterLayoutV9 = () => {
  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row items-start gap-5">
            ...
            <div>
              ...
              <ul className={'mt-4 space-y-4'}>
                ...
                <li className={'space-y-2'}>
                  <p className="text-xs text-gray-200">Telepon</p>
                  <p className={'text-white'}>{profile?.SatuanOrganisasi.telepon}</p>
                </li>
                <li className={'space-y-2'}>
                  <p className="text-xs text-gray-200">Fax</p>
      ...
      <div className="bg-yellow-500 text-footer text-center p-4 text-xs lg:text-base z-50 bottom-0 w-full">
        <div className="container-sm flex items-center justify-between">
          ...
          <ul className={'text-footer justify-center items-center gap-5 hidden lg:flex'}>
            <li className={'flex items-center gap-2'}>
              <FaFacebook className={'size-5'} />
              Facebook
            </li>
