      ...
      <div className="container-sm relative z-10 px-5 lg:px-0 py-8">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 justify-center items-stretch">
          ...
          {announcement?.length > 0 && (
            <div className="w-full lg:w-1/2 bg-primary/50 border border-[#E7F3F1] rounded-[40px] p-5 lg:p-8 shadow-sm flex flex-col">
              <h2 className="text-white mx-auto w-fit text-2xl lg:text-3xl font-semibold text-center mb-8 border-b-4 border-[#CDA327] pb-2 font-montserrat">
              ...
              <div className="flex flex-col">
                {announcement.map((row, k) => (
                  <Link
                    ...
                    className="flex gap-4 lg:gap-5 group border border-[#C8C8C8] p-4 lg:p-6 hover:shadow-md transition bg-white"
                  >
...
export default AgendaAnnouncementV12
