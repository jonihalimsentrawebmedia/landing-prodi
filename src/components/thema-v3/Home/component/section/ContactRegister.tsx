  ...
  return (
    <>
      <div className={'py-10 container flex items-center flex-col'}>
        ...
        <p className="text-center max-w-5xl mx-auto mt-4">
        ...
        <Button className={'text-white mx-auto rounded-full max-w-[600px] mt-5'}>Kunjungi Halaman Kontak & Pendaftaran</Button>
      </div>
    </>
  )
}
