              ...
              <div className="flex flex-col gap-2 mt-5">
                {agenda?.map((row, k) => (
                  <motion.div
                    ...
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.2 }} // 20% terlihat
                  ...
                  >
                    ...
                    >
                      <Image
                        src={row?.gambar}
                        alt="gambar"
                        className="w-[100px] lg:w-[108px] lg:min-w-[108px] h-[104px] lg:h-[136px] object-cover"
                        width={108}
                        height={136}
                      />
                      <div className="flex flex-col gap-1.5">
                        ...
                        <p className="flex items-center gap-1.5 text-xs lg:text-base text-gray-500">
                ...
                <motion.div whileHover={{ scale: 1.05 }} className="mx-auto mt-2">
                  <Link
                    href="/information/agenda"
                    className="flex items-center justify-center rounded-full border-primary border w-fit p-1.5 px-3 text-sm mx-auto"
                  >
