...
const AccreditationPageV13 = () => {
  ...
  return (
    <>
      <JumbotronTitleV13 title={'Akreditasi'} context={'AKREDITASI'} />
      ...
      <div className="lg:p-5 py-5 dark:bg-gray-800">
...
export default AccreditationPageV13
