        ...
        <div className="container-sm py-5">
          ...
          <div className="hidden lg:flex items-start gap-6 lg:gap-8 mt-8">
            <div className="w-1/2 flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-1.5 text-primary text-xs font-semibold py-1.5 rounded-full">
                  <FaRegCalendarAlt className="size-4" />
                  {FirstNews?.tanggal_berita
                    ? format(new Date(FirstNews?.tanggal_berita), 'dd-MM-yyyy')
                    : ''}
                </div>
                <div className="text-primary text-xs font-semibold px-4 py-1.5 rounded-full">
                  {FirstNews?.nama_kategori_berita}
                </div>
              </div>
                ...
                <div key={index} className={'flex items-stretch gap-4'}>
                  ...
                  <div className={'w-full space-y-4'}>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-primary text-xs font-semibold py-1.5 rounded-full">
                        {FirstNews?.nama_kategori_berita}
                      </div>
                    </div>
                    <p className="text-2xl font-semibold line-clamp-2">{FirstNews?.judul}</p>
          ...
          <div className="flex justify-center 5 mt-5">
            <Link href="/information/news">
              <Button className="bg-primary hover:bg-primary text-white flex items-center gap-1.5">
                Lihat Berita
...
export default NewsHomeSectionV13
