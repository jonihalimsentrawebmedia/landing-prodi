...
const InformationNewsSectionV10 = () => {
  ...
  return (
    <>
      <div className="container-sm py-5">
        <h2 className="lg:text-3xl font-semibold mx-auto text-primary text-center border-b-[3px] border-yellow-500 pb-2.5 w-fit">
        ...
        <div className="hidden lg:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-8">
          {news?.map((row) => (
            <Link
              key={row.id_berita}
...
export default InformationNewsSectionV10
