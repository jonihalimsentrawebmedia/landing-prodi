...
const CurriculumPageV10 = (props: Props) => {
  const { data } = props
  ...
  return (
    <>
      <JumbotronTitleV10 title={'Kurikulum'} context={'KURIKULUM'} />
            ...
            >
              {elements?.map((row, k) => (
                <TabsTrigger
                  ...
                  value={row?.value}
                  className={cn(
                    'shadow-none border rounded border-primary w-full bg-white',
...
export default CurriculumPageV10
