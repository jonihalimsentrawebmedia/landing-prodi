...
const RegisterLineSectionV10 = () => {
  ...
  return (
    <>
      <Tabs
        className={clsx(
          'bg-transparent dark:bg-gray-800 justify-start  mt-5 h-full',
          'lg:flex-row! gap-5'
        )}
        value={category}
        onValueChange={setCategory}
      >
        <TabsList className={'lg:w-full lg:flex-col! h-full! max-w-[200px] text-start  gap-2 bg-white shadow p-4'}>
...
export default RegisterLineSectionV10
