  ...
  return (
    <>
      <ProfileLayout title={'Informasi'} context={'INFORMASI'}>
        ...
        <div className="lg:p-5 py-2.5 bg-primary/10">
              ...
              {agenda?.map((row, k) => (
                ...
                >
                  ...
                  <div className={'flex items-center gap-5 mt-2.5'}>
                    ...
                    <p className={'line-clamp-2 text-xl font-semibold'}>{row?.judul}</p>
                  </div>
                </Link>
              ))}
            </div>
...
export default AgendaInformationPageV6
