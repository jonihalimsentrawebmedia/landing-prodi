...
import ButtonDetail from '@/components/thema-V6/Accreditation/buttonDetail'

const ColumnsAccreditations = () => {
...
export default ColumnsAccreditations
