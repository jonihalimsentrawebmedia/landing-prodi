...
const RegisterLineSectionV6 = () => {
  ...
  return (
    <>
      <Tabs
        className={'bg-transparent dark:bg-gray-800 justify-start  mt-5 h-full'}
        value={category}
        onValueChange={setCategory}
      >
        <TabsList className={'w-fit! h-ful text-start  gap-2'}>
          {registration?.map((item, k) => (
            <TabsTrigger
              ...
              className={clsx(
                ...
                'dark:data-[state=active]:bg-footer p-2!'
              )}
            >
...
export default RegisterLineSectionV6
