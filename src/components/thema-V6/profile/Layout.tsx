...
export const ProfileLayoutV6 = (props: Props) => {
          ...
          <div className="container-sm">
            <div className="flex flex-col lg:flex-row items-center gap-5">
              ...
              <div className="flex flex-col gap-4 w-full">
                <h2 className="lg:text-3xl font-semibold text-footer underline decoration-2 underline-offset-8 lg:underline-offset-[24px] decoration-yellow-500">
                  Tentang Program Studi
                </h2>
                <div className="lg:mt-4 bg-linear-to-r from-footer/70 to-footer p-5 rounded-lg w-full space-y-2 lg:space-y-4">
...
export default ProfileLayoutV6
