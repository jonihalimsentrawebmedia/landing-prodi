    ...
    <>
        ...
        <div className="flex items-start gap-5 flex-col lg:flex-row">
          <div className="space-y-4 w-full">
            ...
            <Carousel>
              ...
              {temp?.length > 1 && (
                <>
                  <CarouselNext className={'right-0 bg-[#1F7A63] text-white'} />
                  <CarouselPrevious className={'left-0 bg-[#1F7A63] text-white'} />
                </>
              )}
            </Carousel>
      ...
      <div className="container-sm lg:max-w-[1280px] mx-auto py-5">
        <div className="flex items-center gap-4">
          <h2 className="text-[#1F7A63] text-[24px] font-semibold shrink-0">Baca Juga</h2>
        ...
        <div className="mt-5 grid lg:grid-cols-3 gap-5">
          {promotion?.map((row, k) => (
            <Link
              ...
              key={k}
              className={'flex flex-col gap-5 bg-white border border-[#C8C8C8] rounded-2xl'}
            >
              ...
              <div className="p-4">
                <p className="text-sm font-semibold text-[#1F7A63] flex items-center gap-1.5 py-1.5 px-3 bg-[#E9F5F2] rounded-full w-fit">
                  <FaRegCalendarAlt />
...
export default DetailPromotionV15
