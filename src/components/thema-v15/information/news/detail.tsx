    ...
    <>
      ...
      <div className="bg-white py-5">
        <div className="container-sm lg:max-w-[1280px] mx-auto space-y-4">
          <p className="lg:text-3xl font-semibold text-[#444444]">{newsDetail?.judul}</p>
          <div className="flex lg:flex-row flex-col items-start gap-4">
            <div className="flex items-center gap-1.5">
              <div className={'p-2.5 rounded-full bg-[#1F7A63]'}>
          ...
          <ShareContent
            classNameShare={'bg-[#1F7A63]! px-2.5!'}
...
export default DetailNewsPageV15
