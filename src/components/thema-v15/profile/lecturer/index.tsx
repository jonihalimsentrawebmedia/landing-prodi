...
const ProfileLecturerV15 = () => {
  ...
  const { lecturer, loading } = UseGetLecturer({ page: '1', limit: '9' })
            ...
            <TabsContent key={k} value={row?.link}>
              <div className="w-full space-y-4 py-5">
                <div className="flex items-center gap-4">
                  <h2 className="text-[#1F7A63] text-[24px] font-semibold shrink-0">Dosen</h2>
...
export default ProfileLecturerV15
