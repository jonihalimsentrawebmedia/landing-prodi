          ...
          {TabsData?.map((row, k) => (
            <TabsContent key={k} value={row?.link}>
              <div className="flex flex-col gap-4 mt-5">
                ...
                <div className="bg-linear-to-r bg-[#1F7A63] text-white p-2 to-white border-l-4 border-l-yellow-500">
                  <p className="text-xl font-semibold">Visi</p>
                </div>

                <div
                  className="html-class text-base! text-[#444444]"
                ...
                <div
                  className="html-class flex flex-col gap-2 text-[#444444]"
                ...
                <div
                  className="html-class text-[#444444]"
...
export default ProfileVisionV16
