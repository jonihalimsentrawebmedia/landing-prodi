...
const HeaderLayoutThemaV11 = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-white backdrop-blur-lg border-b-2 border-[#CDA327]">
        ...
        <div className="container-sm mx-auto lg:px-8 lg:py-4 flex items-center justify-between p-2">
          <Link href={'/'} className="flex items-center gap-2">
            ...
            <div className={'space-y-1.5'}>
              <h1 className="text-primary text-xs lg:text-xl font-semibold leading-none whitespace-pre-line">
                {organization?.nama}
              </h1>
...
export default HeaderLayoutThemaV11
