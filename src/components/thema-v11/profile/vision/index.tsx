          ...
          {TabsData?.map((row, k) => (
            <TabsContent key={k} value={row?.link}>
              <div className={'w-full space-y-4 my-5'}>
                ...
                <p className="text-xl font-semibold text-white w-full bg-linear-to-r from-primary to-footer p-1.5 px-3 rounded">
                  Visi
                </p>
                <div
...
export default ProfileVisionV11
