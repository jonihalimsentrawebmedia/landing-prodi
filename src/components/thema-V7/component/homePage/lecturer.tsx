            ...
            {lecturer?.map((row, k) => (
              <div key={k}>
                ...
                >
                  ...
                  />
                  <div className="absolute p-4 bg-linear-to-b from-transparent to-primary w-full bottom-0 rounded-b-lg">
...
export default OurLecturerSectionV7
