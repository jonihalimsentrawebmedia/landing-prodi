...
const ContactSectionV7 = () => {
  ...
  return (
    <>
      ...
      <Tabs
        className={'bg-transparent dark:bg-gray-800 w-full mt-5 flex flex-col items-start'}
        value={category}
        onValueChange={setCategory}
      >
        <TabsList className={'w-full flex h-full text-start gap-2'}>
...
export default ContactSectionV7
